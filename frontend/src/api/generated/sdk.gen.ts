...
/**
 * Reserve a sequential lot number for a facility
 */
export const lotsReserveNumberCreate = <ThrowOnError extends boolean = false>(options: Options<LotsReserveNumberCreateData, ThrowOnError>): RequestResult<LotsReserveNumberCreateResponses, LotsReserveNumberCreateErrors, ThrowOnError> => (options.client ?? client).post<LotsReserveNumberCreateResponses, LotsReserveNumberCreateErrors, ThrowOnError>({
    security: [
        {
            in: 'cookie',
            name: 'sessionid',
