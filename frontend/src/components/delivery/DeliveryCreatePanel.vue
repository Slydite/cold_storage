...
interface Props {
  ...
  deliveryNote?: DeliveryNoteOutput
}
...
const deliveryNoteRef = computed(() => props.deliveryNote)
const {
  party_id,
  partyIdProps,
  dispatch_date,
  ...
  submitForm,
  isSubmitting
} = useDeliveryNoteForm(facilityIdRef, availableLots, deliveryNoteRef, (dnNumber, status) => emit('created', dnNumber, status))
  ...
  <div class="detail-split-panel">
    ...
    <div class="panel-topbar">
      <div class="breadcrumb-context">
        ...
        <span class="active-crumb">{{ props.deliveryNote ? t('delivery.editDraftDeliveryNote') : t('delivery.createDeliveryNote') }}</span>
      </div>
    ...
    <div class="panel-body">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <InputText
            :value="props.deliveryNote ? props.deliveryNote.dn_number : t('grn.autoGenerated')"
            disabled
