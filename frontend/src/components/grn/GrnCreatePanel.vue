...
const grnRef = computed(() => props.grn)
const {
  party_id,
  partyIdProps,
  receipt_date,
  ...
  submitForm,
  isSubmitting
} = useGrnForm(facilityIdRef, grnRef, (grnNumber, status) => emit('created', grnNumber, status))
  ...
  <div class="detail-split-panel">
    ...
    <div class="panel-topbar">
      <div class="breadcrumb-context">
        ...
        <span class="active-crumb">{{ props.grn ? t('grn.editDraftGrn') : t('grn.createNewGrn') }}</span>
      </div>
      ...
      <div class="panel-actions">
        ...
        >
          <FileCheck :size="16" />
          <span>{{ props.grn ? t('delivery.saveAndPost') : t('grn.saveGrn') }}</span>
        </button>
      </div>
    </div>
    ...
    <div class="panel-body">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <InputText
            :value="props.grn ? props.grn.grn_number : t('grn.autoGenerated')"
            disabled
            class="w-full doc-number"
          />
        </div>
